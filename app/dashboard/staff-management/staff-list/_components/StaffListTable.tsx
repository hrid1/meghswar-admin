...
import { staffListColumns } from "./StaffListCol";
import { staffListFakeData, type StaffListRow } from "./StaffListFakeData";
...
export default function StaffListTable() {
    ...
    const filteredRows = useMemo(() => {
        ...
        if (!q) return staffListFakeData;

        return staffListFakeData.filter((r) => {
            return (
    ...
    const columns = useMemo(() => staffListColumns(), []);
