...
import { unProcessedColumns, UnProcessedParcelRow } from "./UnProcessedColumns";
...
export default function UnProcessedTable() {
  ...
  const [selectedParcel, setSelectedParcel] =
    useState<UnProcessedParcelRow | null>(null);

  // search
  const [searchQuery, setSearchQuery] = useState("");

  // map ThirdPartyParcelRow -> UnProcessedParcelRow
  const mappedParcels: UnProcessedParcelRow[] = useMemo(
    () =>
