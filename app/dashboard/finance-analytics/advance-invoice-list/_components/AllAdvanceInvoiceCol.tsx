...
import type { AllAdvanceInvoiceRow } from "./fakeData";
...
function StatusPill({ status }: { status: AllAdvanceInvoiceRow["clearance"] }) {
...
export const allAdvanceInvoiceColumns = (): Column<AllAdvanceInvoiceRow>[] => [
    {
        key: "merchant",
        header: "Merchant",
        width: "30%",
    ...
    },
    {
        ...
        render: (r) => <span className="text-sm font-semibold text-gray-700">{r.totalParcel}</span>,
    },
    {
        key: "advancePaid",
        header: "Advance Paid",
