...
const menuItems = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Operator Approval", href: "/dashboard/hub-management/opperator-approval" },
  ...
  // ✅ add missing + keep prev (rider-transfer kept)
  {
    ...
    children: [
      ...
      { label: "Approve Rider", href: "/dashboard/rider-management/approve-rider" }, // ✅ new
      ...
      { label: "Rider Performance", href: "/dashboard/rider-management/performance" }, // ✅ label updated
  ...
  // ✅ merchant section + missing children
  {
    ...
    children: [
      { label: "Merchant List", href: "/dashboard/merchant-management/merchant-list" },
      { label: "Create Merchant", href: "/dashboard/merchant-management/create-merchant" },
      { label: "Merchant Approval", href: "/dashboard/merchant-management/merchant-approval" },
      { label: "Advance Pay List", href: "/dashboard/merchant-management/advance-pay-list" },
    ],
  },
  ...
  // ✅ new: Finance & Analytics (from screenshot)
  {
    ...
    children: [
      { label: "Create Merch. Invoice", href: "/dashboard/finance-analytics/create-merchant-invoice" },
      { label: "All Invoice List", href: "/dashboard/finance-analytics/all-invoice-list" },
      { label: "Pending Invoice List", href: "/dashboard/finance-analytics/pending-invoice-list" },
      { label: "Clearance List", href: "/dashboard/finance-analytics/clearance-list" },
      { label: "Create Adv. Invoice", href: "/dashboard/finance-analytics/create-advance-invoice" },
      { label: "Advance Invoice List", href: "/dashboard/finance-analytics/advance-invoice-list" },
      { label: "HUB Cash Collection", href: "/dashboard/finance-analytics/hub-cash-collection" },
      { label: "Account Management", href: "/dashboard/finance-analytics/account-management" },
      { label: "Expense Entry", href: "/dashboard/finance-analytics/expense-entry" },
      { label: "Approve Expense", href: "/dashboard/finance-analytics/approve-expense" },
      { label: "Salary Management", href: "/dashboard/finance-analytics/salary-management" },
      { label: "Payout History", href: "/dashboard/finance-analytics/payout-history" },
    ],
  },
  ...
  // ✅ new: Staff Management
  {
    ...
    children: [
      { label: "Staff Creation", href: "/dashboard/staff-management/staff-creation" },
  ...
  // ✅ new: Logout (import LogOut from lucide-react if you want an icon)
  {
    icon: LogOut,
    label: "Logout",
              ...
              return (
                <div key={item.href} className="mb-2">
                  ...
                  <div className={`
                    ...
                    ${!collapsed && isExpanded ? "max-h-125 opacity-100 mt-1" : "max-h-0 opacity-0"}
                  `}>
                    {item.children && (
